...
//            if (!playListNames.contains(playlistFiles.get(i).getPlaylistName())) {
//                playListNames.add(playlistFiles.get(i).getPlaylistName());
////                sameNamePlaylistFiles.add(new SameNamePlaylistFiles(playlistFiles.get(i)));
//                Log.d("playlist", "playlist name " + playlistFiles.get(i).getPlaylistName());
//                Log.d("playlist" , "index of above playlist =  " + sameNamePlaylistFiles.indexOf(new SameNamePlaylistFiles(playlistFiles.get(i))));
//                if (playlistFiles.get(i).isVideoFile || playlistFiles.get(i).isMusicFile)
//                    number_media.add(1);
//                else
//                    number_media.add(0);
//            } else {
//                if (playlistFiles.get(i).isVideoFile || playlistFiles.get(i).isMusicFile) {
//                    Integer integer = number_media.get(playListNames.indexOf(playlistFiles.get(i).getPlaylistName()));
//                    number_media.remove(playListNames.indexOf(playlistFiles.get(i).getPlaylistName()));
//                    number_media.add(playListNames.indexOf(playlistFiles.get(i).getPlaylistName()),  integer + 1);
//                }
////                sameNamePlaylistFiles.get(playListNames.indexOf(playlistFiles.get(i).getPlaylistName())).add(playlistFiles.get(i));
//            }
        }
...
//                for (int i = 0; i < sameNamePlaylistFiles.get(position).getMusicFiles().size(); i++) {
//                    byte[] arr = getAlbumArt(sameNamePlaylistFiles.get(position).getMusicFiles().get(i).getPath());
//                    if (arr != null) {
//                        Glide.with(mContext)
//                                .load(arr)
//                                .into(tempHolder.imageView);
