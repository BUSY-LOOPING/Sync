...
public class AlbumDetailsAdapter extends RecyclerView.Adapter<AlbumDetailsAdapter.MyHolder> {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        holder.more.setOnClickListener(v -> {
            ...
            bundle.putSerializable("arraylist", albumFiles);
            bottomSheet.setArguments(bundle);
            bottomSheet.setWindow(((AlbumDetails)mContext).getWindow());
            bottomSheet.setAlbumDetailsAdapter(AlbumDetailsAdapter.this);
            bottomSheet.show(((AlbumDetails)mContext).getSupportFragmentManager(), bottomSheet.getTag());
        });
    ...
    public class MyHolder extends RecyclerView.ViewHolder {
        private final ImageView album_img, more;
        private final TextView album_name, artist_album;
        private final Indicator indicator;

        public MyHolder(@NonNull View itemView) {
            super(itemView);
            more = itemView.findViewById(R.id.menuMore);
