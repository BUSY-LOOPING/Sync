...
//                db = new DataBaseHelperPlaylist(mContext, PLAYLIST_NAME, null, 1);
    ...
    private void setList(Bundle bundle) {
        if (bundle != null) {
            parent = (File) bundle.get(FileActivity.PARENT);
            if (parent != null) {
    ...
    public static ArrayList<VideoFiles> getAllVideos(File parent, Context context) {
...
//        }
    ...
    public static ArrayList<MusicFiles> getAllAudio(File parent, Context context) {
...
// every column, although that is huge waste, you probably need
    ...
    class getFilesInParent extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            musicFiles = getAllAudio(parent, mContext);
            videoFiles = getAllVideos(parent, mContext);
            return null;
        }
