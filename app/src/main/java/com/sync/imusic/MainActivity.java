...
import static com.sync.imusic.MusicService.NOW_PLAYING;
import static com.sync.imusic.MusicService.initiated;
import static com.sync.imusic.MusicService.playing;
...
import com.sync.imusic.fragment.ViewPagerAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private CoordinatorLayout.LayoutParams fabInitialParams;
...
//        layoutParams.setBehavior(new BottomNavigationViewBehavior());
        ...
        fabInitialParams = (CoordinatorLayout.LayoutParams) fab.getLayoutParams();
...
//        getSupportFragmentManager().beginTransaction().remove(new AlbumsFragment()).commitAllowingStateLoss();
    ...
    public CoordinatorLayout.LayoutParams getFabInitialParams() {
        return fabInitialParams;
    }

    public static Intent getMainIntent() {
        return MainActivity.mainIntent;
    }
